...
import FilesUploadComponent from '../../fileUploadComponent.jsx';
class Bio extends React.Component {
  ...
  onFilesChange(e) {
    ...
    for (let i = 0; i < files.length; i++) {
      let file = URL.createObjectURL(e.target.files[i]);
      arr.push(file);
    }
    this.setState({
      selectedFiles: arr,
  ...
  render() {
    return (
      <section className="ashade-section">
        <div
          className="ashade-row ashade-row-fullheight exclude-header"
          style={{ position: "relative", top: "80px", display: "grid" }}
          id="serviceProfile"
        >
          <img
            className="avatar"
            ...
            <div className="modal">
              ...
              <div className="modal__overlay">
                ...
                <div className="modal__wrap" id="editprofilecontent">
                  ...
                  <img
                    id="imgedit"
                    src="blob:http://localhost:3000/298df129-adb8-4ad9-8811-5043775c8fb5"
                    src={
                  ...
                  >
                    <div className="col-md-12" id="imputsforedit">
                      <input
                        type="text"
                        name="firstName"
                  ...
                  <div className="ashade-col col-6 align-bottom hide-on-tablet-port hide-on-phone"></div>
                </div>
              </div>
            </div>
          </div>
